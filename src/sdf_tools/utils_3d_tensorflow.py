...
from sdf_tools.utils_3d import compute_sdf_and_gradient as _compute_sdf_and_gradient
...
def compute_sdf_and_gradient_batch(env, res, origin_point, batch_size: int):
    ...
    for b in range(batch_size):
        sdf, sdf_grad = _compute_sdf_and_gradient(env[b], res[b], origin_point[b])
        sdfs.append(sdf)
...
def compute_sdf_and_gradient(env, res, origin_point):
    ...
    return _compute_sdf_and_gradient(env, res, origin_point)
